...
(* OASIS_START *)
(* DO NOT EDIT (digest: 387a48890b0e74fbb81efc1bd0398334) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "FooBar allows to combine foo and bar efficiently. It also allows to interface with baz."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dfs.ml"});
               Executable
                 ({
                     cs_name = "gdemo";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "gdemo.ml"});
               Executable
                 ({
                     cs_name = "oop";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "oop.ml"});
               Executable
                 ({
                     cs_name = "rowpoly";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "rowpoly.ml"})
            ];
     ...
     oasis_digest = Some "\127\2264W>\151m\000\n\207\171\019\";K|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
